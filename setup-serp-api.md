# Bright Data SERP API 설정

### Step 1: Dashboard에 액세스
- Bright Data 계정에 [로그인](https://brightdata.co.kr/cp/start)합니다
- 왼쪽 메뉴에서 "Proxies & Scraping"으로 이동합니다
- "SERP API"를 선택하고 "Get Started"를 클릭합니다
...
### Step 2: Zone 생성
- 설명이 포함된 Zone 이름을 입력합니다(생성 후 변경할 수 없습니다)
- "Add"를 클릭합니다
- 팝업 대화상자에서 Zone 생성을 확인합니다
...
### Step 3: Credentials에 액세스
- 생성이 완료되면 Overview 페이지로 이동됩니다
- 다음 두 개의 탭에서 credentials를 확인합니다:
    - Direct API Access
